...
export function Contact() {
	...
	return (
		<div
			id='contact'
			className='relative flex flex-col md:grid md:grid-cols-2 2xl:mb-10 bg-primary dark:bg-dark text-light dark:text-light h-full rounded-xl pt-1 pb-1 mt-1 mb-1'
		>
			<div className='order-1 md:order-none m-18 mb-6 flex items-center flex-col'>
				...
				<Buttons
					...
					bgPrimary='bg-fall dark:bg-primary'
					bgHover='bg-tangerine hover:dark:bg-primHover'
					paddingX='4'
					onclick={showForm}
				/>
			</div>
			...
			<div className='order-5 2xl:order-none col-span-2 mt-24 md:mt-20 mb-3 2xl:mb-7'>
				...
				<div className='flex justify-center space-x-4 text-2xl '>
					<a href='#' className='hover:text-fall dark:hover:text-primary'>
						<FaInstagram />
					</a>
					<a href='#' className='hover:text-fall dark:hover:text-primary'>
						<FaFacebook />
